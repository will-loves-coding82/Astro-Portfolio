...
In an era where technology is rapidly shifting towards parallel computing and artificial intelligence, I felt it was important to 
...
<Image src="/images/blog/cuda-project/gaussian_plot.png" alt="design guide" fit="cover" width="700" height="400" class="w-full my-4 max-h-[480px] rounded-xl"/>
...
<br/>
<Image src="/images/blog/cuda-project/2D_convolution.svg" alt="2D convolution" width="700" height="400" class="bg-white w-full max-h-[340px] rounded-xl"/>
...
<br/>
<Image src="/images/blog/cuda-project/cuda_threads.png" alt="design guide" fit="cover" width="700" height="400" class="w-full my-4 max-h-[440px] rounded-xl"/>
...
<p>
With the basics covered, let's move onto memory. Below is the setup for the memory allocations for the Device GPU 
...
<Image src="/images/blog/cuda-project/pug_before_after.png" alt="design guide" fit="cover" width="700" height="400" class="w-full my-4 max-h-[440px] rounded-xl"/>
